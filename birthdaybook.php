...
<div class="login-wrap">
	<div class="login-form">
		<form method="post" action="birthdaybook.php" autocomplete="on">
		<img src="bk2.jpg" alt="Wedding Event">
		<div class="head">
		<h1>Birthday Party Event Booking</h1>
		<hr>
		<h2>Party According To</h2>
		<select id="select" name="partytype" required>
		<option label=" "></option>
...
<script type="text/javascript">
    ...
    $('#partydate').attr('min', maxDate);
		...
		<select id="select" name="partyloc" required>
		<option label=" "></option>
		...
		<h2>Your Cake</h2>
		<select id="select" name="cake" required>
		<option label=" "></option>
		...
		<br><br>
		<input type="number" id="name" name="guests" placeholder="Number of Guests" required>
		<h2>Food Course</h2>
		<select id="select" name="foodcourse" required>
		<option label=" "></option>
		...
		<h2>Food Choice</h2>
		<select id="select" name="foodchoice" required>
		<option label=" "></option>
		...
		<label for="name">Name</label>
 		 <input type="text" id="name" name="bname" pattern="(?! )[A-Za-z ]*" required>
  		<label for="username">UserName</label>
 		 <input type="text" id="username" name="username1"required>
		<label for="email-id">Email ID</label>
 		 <input type="email" id="email-id" name="emailid1"required>
		<label for="contact">Contact Number</label>
 		 <input type="text" id="contact" name="contact1" pattern="[0-9]{10}"required>
		<br><br><br>
		<div class='karthi'>
