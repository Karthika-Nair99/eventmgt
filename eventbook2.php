...
<div class="login-wrap">
	<div class="login-form">
		...
		<img src="bg3.jpg" alt="Wedding Event">
		<div class="head">
<h1>Corporate Events, Concerts And Award Nights Event Booking</h1>
    ...
    $('#eventdate').attr('min', maxDate);
		...
		<h2>Your Budget</h2>
		<select id="select" name="budget1" required>
		<option label=" "></option>
		...
		<h2>Event Venue</h2>
		<select id="select" name="eventvenue" required>
		<option label=" "></option>
		...
		<select id="select" name="guests3" required>
		<option label=" "></option>
		...
		<h3>Decoration Theme</h3>
		  <select id="select" name="theme1" required>
		  <option label=" "></option>
    ...
    $("form").submit(function(){
		...
		<label for="name">Name</label>
 		 <input type="text" id="name" name="ename" pattern="(?! )[A-Za-z ]*" required>
  		<label for="username">UserName</label>
 		 <input type="text" id="username" name="username3" required>
		<label for="email-id">Email ID</label>
 		 <input type="email" id="email-id" name="emailid3" required>
		<label for="contact">Contact Number</label>
 		 <input type="text" id="contact" name="contact3" pattern="[0-9]{10}"required>
		<br><br><br>
		<div class='karthi'>
