...
<div class="login-wrap">
	<div class="login-form">
		...
		<hr>
		<h2>Event Type</h2>
		<select id="select" name="eventtype" required>
		<option label=" "></option>
...
<script type="text/javascript">
    ...
    var maxDate = year + '-' + month + '-' + day;
    $('#tilldate').attr('min', maxDate);
});</script>
		<label for="tilldate">Till Date</label>
		<input type="date" name="tilldate" id="tilldate" required>
		
		<h2>Your Budget</h2>
		<select id="select" name="budget2" required>
		<option label=" "></option>
...
<script type="text/javascript">
    ...
    $("form").submit(function(){
		if ($('input[type=checkbox][name="techno[]"]').filter(':checked').length < 1){
        alert("Check at least one Function Type!");
		return false;
		}
    });
});</script>
		...
		<select id="select" name="guests" required>
		<option label=" "></option>
		...
		<h3>Hall Size</h3>
		<select id="select" name="hallsize" required>
		<option label=" "></option>
		...
		<h3>Decoration Theme</h3>
		  ...
		  <select id="select" name="theme"required>
		  <option label=" "></option>
		...
		$(document).ready(function(){
    $("form").submit(function(){
		if ($('input[type=checkbox][name="tech[]"]').filter(':checked').length < 1){
        alert("Check at least one Food Type!");
		return false;
		}
    });
});</script>
		...
		<label for="name">Name</label>
 		 <input type="text" id="name" name="wname" pattern="(?! )[A-Za-z ]*" required>
  		<label for="username">UserName</label>
 		 <input type="text" id="username" name="username2" required>
		<label for="email-id">Email ID</label>
 		 <input type="email" id="email-id" name="emailid2" required>
		<label for="contact">Contact Number</label>
 		 <input type="text" id="contact" name="contact2" pattern="[0-9]{10}"required>
		<br><br><br>
		<div class='karthi'>
