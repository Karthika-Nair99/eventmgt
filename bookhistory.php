...
echo "</table>";
echo"<form method='post' action='invoice.php' autocomplete='on'>";
echo"<div class='button1'>";
echo"<button  type='submit' name='button1'>INVOICE!!!</button>";
echo"</div>";
echo"</form>";
...
echo"<button type='submit' name='button2'>INVOICE</button>";
echo"</div>";
echo"</form>";
...
echo"<button type='submit' name='button3'>INVOICE</button>";
echo"</div>";
echo"</form>";
mysqli_close($con);
?>
